...
namespace September2020.pages
{
    class CompanyPage
    {
        ...
        // Implimentation of specflow in company page

        //create company using SF
        internal void CreateCompanyWithValues(IWebDriver driver)
        {
            try
            {
                //click createnew company
        ...
        //validate create company SF
        internal void ValidateCreateCompanyWithValues(IWebDriver driver)
        {
        ...
        //edit using SF
        internal void EditCreateCompanyWithValues(IWebDriver driver)
        {
            driver.Navigate().Refresh();
            Thread.Sleep(1000);
            //wait.WaitForElement(driver, "XPath", "//*[@id=''companiesGrid']/div[4]/a[4]/span", 500);
        ...
        //verify edited company SF
        internal static bool IsEditRecordCreated(IWebDriver driver)
        {
            try
            {
                //goto last page
            ...
            wait.WaitForElement(driver, "Xpath", "//*[@id='companiesGrid']/div[3]/table/tbody/tr[last()]/td[1]", 400);
            IWebElement editedcompanyLastpageLastelement = driver.FindElement(By.XPath("//*[@id='companiesGrid']/div[3]/table/tbody/tr[last()]/td[1]"));
            if (editedcompanyLastpageLastelement.Text == "ABC LTD NEW")
            {
                return true;
            }
            else
        ...
        //Delete using SF
        internal void DeleteCreatedCompanyWithValues(IWebDriver driver)
        {
            driver.Navigate().Refresh();
            Thread.Sleep(2000);
            wait.WaitForElement(driver, "XPath", "//*[@id='companiesGrid']/div[4]/a[4]", 4000);
        ...
        //validate delete using sF
        internal static bool IsRecordDeleted(IWebDriver driver)
        {
            Thread.Sleep(5000);
            wait.WaitForElement(driver, "XPath", "//*[@id='companiesGrid']/div[3]/table/tbody/tr[last()]/td[1]", 400);
            IWebElement deleteCompanyText = driver.FindElement(By.XPath("//*[@id='companiesGrid']/div[3]/table/tbody/tr[last()]/td[1]"));
            if (deleteCompanyText.Text != "ABC LTD NEW")
            {
